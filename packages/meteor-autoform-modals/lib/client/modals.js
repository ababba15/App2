...
Template.autoformModals.rendered = function () {
  ...
  return $('#afModal').on('hidden.bs.modal', function () {
    ...
    sessionKeys = ['cmCollection', 'cmOperation', 'cmTp', 'cmDoc', 'cmButtonHtml', 'cmFields', 'cmOmitFields', 'cmButtonContent', 'cmTitle', 'cmButtonClasses', 'cmPrompt', 'cmTemplate', 'cmLabelClass', 'cmInputColClass', 'cmPlaceholder', 'cmFormId', 'cmAutoformType', 'cmMeteorMethod', 'cmCloseButtonContent', 'cmCloseButtonClasses'];
    results = [];
